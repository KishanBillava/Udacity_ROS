...
# xterm  -e  " source ${PATH_CATKIN_WS}/devel/setup.bash; rosun add_markers add_markers " &
sleep 5
xterm  -e  " source ${PATH_CATKIN_WS}/devel/setup.bash; roslaunch pick_objects pick_objects.launch "
# xterm  -e  " source ${PATH_CATKIN_WS}/devel/setup.bash; rosrun pick_objects pick_objects "
