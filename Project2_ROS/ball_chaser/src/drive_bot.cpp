...
ros::Publisher motor_comand_publisher;
...
int main(int argc, char**argv)
{
    ...
    motor_comand_publisher = n.advertise<geometry_msgs::Twist>("/cmd_vel",10);
